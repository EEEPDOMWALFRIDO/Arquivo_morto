<?php
    ...
    $sql = "select * from tbestudante where codest = '$id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800">Alterar - Estudante</h1>
                    <br>
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a class="btn btn-success" href="buscaestudante.php"><i class="fa fa-arrow-left"></i> Voltar</a>
								...
								<div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
											...
											<form name="f1" method="POST" action="alterarestudante.php"> 
                                            <div class="input-group">											
										    <input value="<?php echo $linha['codest'];?>" class="form-control" type="hidden" name="codest" id="codest" >
										    </div>
										    <label>Nome</label><br>
										    <div class="input-group">											
										    <input value="<?php echo $linha['nome'];?>" placeholder="informe o nome do aluno" class="form-control" type="text" name="nome" id="nome" required>
										    </div>
											<br>
											<label>Nome da responsável(mãe)</label><br>
											<div class="input-group">											
											    <input value="<?php echo $linha['nomedamae'];?>"placeholder="informe o nome da responsável(mãe)" class="form-control" type="text" name="nomedamae" id="nomedamae" required>
											</div>
                                            <br>
											<label>Ano</label><br>
											<div class="input-group">											
											...
											<div class="input-group">	
                                                <select class="form-control" name="codcurso" id="codcurso" required>
                                                ...
                                                <?php 
                                                    ...
                                                    //criar sql de consulta
                                                    $sql2 = "select * from tbcurso order by curso";
                                                    ...
                                                    if ($consulta2 == true){
                                                        ...
                                                        if($consulta2->num_rows > 0){
                                                           ...
                                                           while($linha2=$consulta2->fetch_array(MYSQLI_ASSOC)){
                                                                 echo '<option value="'.$linha2['codcurso'].'">'.$linha2['curso'].'</option>';
                                                           }
                                                        }
                                                    }
											...
											<div class="input-group">											
											    <input value="<?php echo $linha['estante'];?>" placeholder="informe a estante do arquivo" class="form-control" type="text" name="estante" id="estante" required>
											</div>
                                            
											
											<br>
											<label>Sequência</label><br>
											<div class="input-group">											
											    <input value="<?php echo $linha['seq'];?>" placeholder="informe o número de sequencia da pasta" class="form-control" type="number" name="seq" id="seq" required>
											</div>
											<hr>
