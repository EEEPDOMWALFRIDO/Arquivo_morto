        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800">Cadastro - Estudante</h1>
                    <br>    
                    <!-- Page Heading -->
								...
								<div class="card-body">
  										   ...
  										   if(isset($_GET['cad'])){
											   if($_GET['cad']=='ok'){
												  echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
															  <strong>Atenção!</strong> Estudante cadastrado com sucesso!
                                           ...
                                           if(isset($_GET['cad'])){
                                               if($_GET['cad']=='erro'){
                                                  echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                              <strong>Atenção!</strong> Erro ao cadastrar estudantes.
                                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                              </button>
                                                            </div>';  
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
											...
											<form name="f1" method="POST" action="salvarestudante.php"> 
											
										    <label>Nome</label><br>
										    <div class="input-group">											
										    <input placeholder="informe o nome do aluno" class="form-control" type="text" name="nome" id="nome" required>
										    </div>
											<br>
											<label>Nome da responsável(mãe)</label><br>
											<div class="input-group">											
											    <input placeholder="informe o nome da responsável(mãe)" class="form-control" type="text" name="responsavel" id="responsavel" required>
											</div>
                                            <br>
											<label>Ano</label><br>
											<div class="input-group">											
											...
											<div class="input-group">	
                                                ...
                                                <?php 
                                                   include('banco.php');
                                                    ...
                                                    $sql = "select * from tbcurso order by curso";
                                                    ...
                                                    if ($consulta == true){
                                                        ...
                                                        if($consulta->num_rows > 0){
                                                           ...
                                                           while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
                                                                 echo '<option value="'.$linha['codcurso'].'">'.$linha['curso'].'</option>';
                                                           }
                                                        }
                                                    }
											...
											<div class="input-group">											
											    <input placeholder="informe a estante do arquivo" class="form-control" type="text" name="estante" id="estante" required>
											</div>
											<br>
											<label>Sequência</label><br>
											<div class="input-group">											
											    <input placeholder="informe o número de sequencia da pasta" class="form-control" type="number" name="seq" id="seq" required>
											</div>
