        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800">Cadastro - Curso</h1>
                    <br>
                    <!-- Page Heading -->
								...
								<div class="card-body">
  										   ...
  										   if(isset($_GET['cad'])){
											   if($_GET['cad']=='ok'){
												  echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
															  <strong>Atenção!</strong> Curso cadastrado com sucesso!
                                           ...
                                           if(isset($_GET['cad'])){
                                               if($_GET['cad']=='erro'){
                                                  echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                              <strong>Atenção!</strong> Erro ao cadastrar curso!
                                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                              </button>
                                                            </div>';  
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
											...
											<form name="f1" method="POST" action="salvarcurso.php"> 
											
										    <label>Nome</label><br>
										    <div class="input-group">											
										    <input placeholder="informe o nome do curso" class="form-control" type="text" name="curso" id="curso" required>
										    </div>
