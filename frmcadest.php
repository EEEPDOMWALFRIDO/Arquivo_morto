        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-0 text-gray-800">Cadastro - Usuário</h1>
                    <br>
                    <!-- Page Heading -->
								...
								<div class="card-body">
								       <?php
  										   if(isset($_GET['cad'])){
											   if($_GET['cad']=='ok'){
												  echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
															  <strong>Atenção!</strong> Usuário cadastrado com sucesso!
                                           ...
                                           if(isset($_GET['cad'])){
                                               if($_GET['cad']=='erro'){
                                                  echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                                              <strong>Atenção!</strong> Erro ao cadastrar o usuário!
                                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                              </button>
                                                            </div>';  
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
										    ...
										    <label>Nome</label><br>
										    <div class="input-group">											
										    <input placeholder="Informe seu nome" class="form-control" type="text" name="nome" id="nome" required>
										    </div> <br>
											
											<label>E-mail</label><br>
											<div class="input-group">											
											    <input placeholder="Informe seu e-mail" class="form-control" type="e-mail" name="email" id="email" required>
											</div> <br>
