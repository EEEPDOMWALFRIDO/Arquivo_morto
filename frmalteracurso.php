<?php
    ...
    $sql = "select * from tbcurso where codcurso = '$id'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a class="btn btn-success" href="buscacurso.php"><i class="fa fa-arrow-left"></i> Voltar</a>
								...
								<div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
											...
											<form name="f1" method="POST" action="alterarcurso.php"> 
											
										    
										    <div class="input-group">											
										    <input value="<?php echo $linha['codcurso'];?>" class="form-control" type="hidden" name="codcurso" id="codcurso" >
										    </div>
											
											<label>Curso</label><br>
										    <div class="input-group">											
										    <input value="<?php echo $linha['curso'];?>" placeholder="informe o nome do curso" class="form-control" type="text" name="curso" id="curso" required>
										    </div>
