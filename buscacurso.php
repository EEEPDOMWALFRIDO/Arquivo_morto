            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Busca - Curso</h1>
						<a href="frmcadcurso.php" class="btn btn-lg"><i class="fa fa-plus"></i> Novo</a>
                    ...
                    <div class="row">
						...
						<?php
					        if(isset($_GET['alter'])){
								if ($_GET['alter']=='ok'){
									echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
												 <strong>Atenção!</strong> Curso alterado com sucesso!
							 ...
							 if(isset($_GET['alter'])){
								if ($_GET['alter']=='erro'){
									echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
												 <strong>Atenção!</strong> Erro ao alterar curso!
												 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												 </button>
											 </div>';
                            ...
                            if(isset($_GET['delete'])){
                                if ($_GET['delete']=='ok'){
                                    echo    '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                                 <strong>Atenção!</strong> Curso deletado com sucesso!
                                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                 </button>
                                             </div>';
                             ...
                             if(isset($_GET['alter'])){
                                if ($_GET['alter']=='erro'){
                                    echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                 <strong>Atenção!</strong> Erro ao deletar curso!
                                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                 </button>
                                             </div>';
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <form method="POST" action="buscacurso.php">
													<label>Busca de Cursos</label>
													<div class="input-group">
							  ...
							  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<?php
												    ...
												    if(isset($_POST['texto'])){
														  ...
														  $sql = "select * from tbcurso where curso like '%$texto%'";
															 ...
															 if($consulta->num_rows > 0){
																...
																while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
																   echo '<tr>
																			...
																			<td>'.$linha['curso'].'</td>
																			<td>
																			  <a class="btn btn-sm btn-info" href="frmalteracurso.php?id='.$linha['codcurso'].'"><i class="fa fa-edit"></i> Alterar</a>
																			  <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal'.$linha['codcurso'].'">
                                                                                    <i class="fa fa-trash"></i> Excluir
                                                                                </button>
																			</td> 
																		</tr>';
                                                                        echo '
                                                                        <div class="modal fade" id="deleteModal'.$linha['codcurso'].'" tabindex="-1" aria-labelledby="deleteModalLabel'.$linha['codcurso'].'" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header bg-danger text-white">
                                                                                        <h5 class="modal-title" id="deleteModalLabel'.$linha['codcurso'].'">Confirmação de Exclusão</h5>
                                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                    </div>
                                                                                    <div class="modal-body">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        <a href="excluircurso.php?id='.$linha['codcurso'].'" class="btn btn-danger">Excluir</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>';
