                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-auto">
                                    ...
                                    <form class="user" name="flogin" method="POST" action="login.php">
                                        ...
                                        <button type="submit" class="btn btn-lg btn-success btn-user btn-block"><i class="fa fa-lock-open"></i> Entrar</button>
										   ...
										   if(isset($_GET['login'])){
											   if ($_GET['login']=='erro'){
												   echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
															  <strong>Atenção!</strong> Usuario ou senha invalidos!
